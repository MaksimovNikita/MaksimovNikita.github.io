...
$('.title').each(function(){
  $(this).html("Земля".replace(/([^\x00-\x80]|\w)/g, "<span class='letter'>$&</span>"));
});
...
var photo_planet = ["Earth.jpg", "Mars.jpg", "Jupiter.jpg", "Saturn.jpg", "Uranus.jpg", "Neptune.jpg", "Mercury.jpg", "Venus.jpg"];
var planet = ["Земля", "Марс", "Юпитер", "Сатурн", "Уран", "Нептун", "Меркурий", "Венера"];